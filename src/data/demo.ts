...
export const PRICING = [
  {
    ...
    features: ["2 agent aktif", "3 rutinitas terjadwal", "Skill dasar", "Model Malika-managed", "Support WhatsApp"],
    cta: "Pilih Starter",
    popular: false,
  },
  {
    ...
    features: [
      ...
      "Semua skill + instal baru",
      "BYO subscription (GPT/Claude/Grok)",
      "Approval flow aksi sensitif",
      "Support prioritas",
    ],
    cta: "Pilih Growth",
    popular: true,
  },
  {
    ...
    features: [
      "Agent tanpa batas",
      "Rutinitas + paralel eksekusi",
      "Skill custom request",
      "Kuota token prioritas",
      "Admin multi-user + audit log",
      "Dedicated manager",
    ],
    cta: "Hubungi Kami",
    popular: false,
